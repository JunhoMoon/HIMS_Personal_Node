...
//    }
    ...
    internal fun createMessage(requestType:String, from:String):String{
        return "{\"requestType\" : \"$requestType\", \"from\" : \"$from\"}"
    }
    ...
    internal fun createMessage(requestType:String, from:String, receiverPublicKey:String, message:String?):String{
        return "{\"requestType\" : \"$requestType\", \"from\" : \"$from\", \"receiverPublicKey\" : \"$receiverPublicKey\", \"message\" : \"$message\"}"
    }
